    ...
    <div class="container-site relative z-10">
      ...
      >
        ...
        <div class="contact-form-wrap lg:col-span-3 bg-white rounded-2xl shadow-card overflow-hidden">
          ...
          <!-- Form header stripe -->
          <div class="bg-gradient-to-r from-accent to-emerald-600 px-8 py-4 flex items-center gap-3">
        ...
        <div class="contact-info-wrap lg:col-span-2 flex flex-col gap-5">
          ...
          <div class="bg-ink rounded-2xl p-7 text-white relative overflow-hidden">
            ...
            <a :href="phoneTel" class="inline-flex items-center gap-2 bg-accent text-white font-semibold text-sm px-5 py-3 rounded-xl hover:bg-emerald-600 transition-colors duration-200">
              <Icon icon="mdi:phone" />
              Позвонить
            </a>
            <!-- Working hours -->
