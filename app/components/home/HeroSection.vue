...
<template>
  <section class="relative pt-20 pb-8 lg:min-h-screen lg:flex lg:flex-col lg:justify-center">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
      <div class="absolute inset-0 bg-gradient-to-br from-bg via-blue-50/30 to-blue-50/30" />
      ...
      <div class="grid lg:grid-cols-2 lg:gap-14 lg:items-center">
        ...
        <div class="hero-img-col relative">
          <div class="relative rounded-2xl sm:rounded-3xl overflow-hidden aspect-[4/3] bg-slate-100">
            ...
            <!-- Placeholder -->
            <div class="absolute inset-0 bg-gradient-to-br from-slate-200 via-slate-100 to-blue-50/60 flex items-center justify-center">
    ...
    <!-- Scroll / Back to top -->
    <button
      class="hidden lg:flex fixed right-10 xl:right-14 bottom-10 z-50 w-12 h-12 rounded-full bg-accent items-center justify-center text-white shadow-lg hover:bg-[#091545] hover:scale-105 transition-all duration-200"
