        ...
        <tr>
          <td align="center" style="padding-bottom:24px;">
            <table cellpadding="0" cellspacing="0">
              <tr>
                <td style="background:#15803D;border-radius:12px;width:40px;height:40px;text-align:center;vertical-align:middle;">
                ...
                <td style="padding-left:10px;font-size:20px;font-weight:700;color:#0f172a;">
                  Чистый <span style="color:#15803D;">Дом</span>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(15,23,42,0.08);">
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td style="background:linear-gradient(135deg,#15803D 0%,#0284c7 100%);padding:24px 32px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="padding:8px 0;">
              ...
              <tr>
                <td style="padding:16px 32px;border-bottom:1px solid #f1f5f9;">
                  ...
                  <a href="tel:${phone}" style="color:#15803D;font-size:18px;font-weight:700;text-decoration:none;">${phone}</a>
                </td>
              </tr>
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td style="padding:20px 32px 28px;">
                  <a href="tel:${phone}"
                     style="display:block;background:#15803D;color:#ffffff;text-align:center;padding:14px 24px;border-radius:12px;font-size:15px;font-weight:700;text-decoration:none;letter-spacing:0.01em;">
                    Позвонить клиенту
                  </a>
                </td>
              </tr>
